...
<input type="hidden" name="ch" value="1"></input>
      ...
      <tr>
        <td height="204"></td>
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#003366">
              ...
              <tr>
                    <td height="27" colspan="2" valign="center" ><div align="center"><label style="color:#FFFFFF;font-weight:bold;class:classname;align:center">Invalid Username or Password</label> </div></td>
                    </tr>
              ...
              <tr>
                <td height="22" colspan="3" align="center" valign="middle">
                  <input type="button" class="classname" width="100" height="22" name="Try Again" value="Try Again" onClick ="window.location='<%=request.getContextPath()%>/jsp/Login.jsp'"></input>
                  <input type="button" class="classname" value="Cancel" onClick ="window.location='<%=request.getContextPath()%>/jsp/Home.jsp'"></input>
