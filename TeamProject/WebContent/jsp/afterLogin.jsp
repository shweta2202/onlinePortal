...
<input type="hidden" name="ch" value="2"></input>
      ...
      <tr>
        <td height="204"></td>
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#003366">
              ...
              <tr>
                <td height="25" align="center" valign="bottom"><div align="center" class="style1">Enter License Plate Number Without Spaces </div></td>
              </tr>
              
              <tr>
                <td height="25" align="center" valign="top">
                  <input type="text" name="plNo" />
                </td>
              </tr>
              <tr>
                <td height="32">&nbsp;</td>
              ...
              <tr>
                <td height="22" align="center" valign="middle">
                   <input type="submit" class="classname" width="100" height="22" name="Enter" value=" Enter "/>
                                </td>
              </tr>
              <tr>
                <td height="48">&nbsp;</td>
